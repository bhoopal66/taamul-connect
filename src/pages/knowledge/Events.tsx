        ...
        <section className="relative py-24 lg:py-32 bg-gradient-to-br from-primary via-primary/90 to-primary/80">
          <div className="container mx-auto px-4 relative z-10">
            <div className={cn("text-center max-w-3xl mx-auto", isRTL && "text-right")}>
              ...
              <h1 className="text-4xl lg:text-5xl font-bold text-white mb-4">{t("nav.events")}</h1>
              <p className="text-lg text-white">{t("nav.eventsDesc")}</p>
            </div>
          </div>
        </section>
        <section className="py-24 bg-background">
          <AnimatedSection className="container mx-auto px-4">
            <div className="text-center max-w-xl mx-auto">
              ...
              <p className="text-muted-foreground">{isRTL ? "نحن نخطط لفعاليات مثيرة. تابعونا لمعرفة المزيد عن الأحداث القادمة!" : "We're planning exciting events. Follow us to learn about upcoming happenings!"}</p>
            </div>
          </AnimatedSection>
        </section>
      </main>
