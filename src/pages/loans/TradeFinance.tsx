...
const features = [
  {
    ...
    description: "Secure your international transactions with bank-backed LCs",
  },
  {
    icon: Ship,
    title: "Import/Export Finance",
    description: "Pre and post-shipment financing for smooth trade operations",
  },
  {
    icon: CreditCard,
        ...
        <section>
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Everything you need to manage international trade with confidence.
            </p>
          </div>
