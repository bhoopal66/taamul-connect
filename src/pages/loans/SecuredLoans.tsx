...
const features = [
  ...
  },
  {
    ...
    description: "Repayment periods up to 84 months for larger loan amounts",
  },
  {
    icon: Lock,
    title: "Higher Loan Amounts",
    description: "Access up to 80% of collateral value with secured financing",
  },
];

const eligibility = [
  "Business operating in UAE for at least 2 years",
  "Minimum annual turnover of AED 2 million",
...
const SecuredLoans = () => {
  return (
    <ServicePageLayout heroSection={<HeroSection />} breadcrumbs={breadcrumbs}>
        ...
        <section>
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Get the best rates and terms by leveraging your business assets.
            </p>
          </div>
