...
const translations = {
  en: {
    ...
    businessLoansPage: {
      ...
      whyChooseTaamul: "Why Choose TAAMUL?",
      fastTransparent: "Fast, Transparent Business Loan Financing",
      fastTransparentDesc: "We've simplified the business loan process so you can focus on what matters most - growing your business.",
  ...
  ar: {
    ...
    loanPages: {
      ...
      taamul: "تعامل",
      advantage: "ميزة",
      advantageDesc: "كيف يعمل تمويل نقاط البيع (POS)؟ احصل على تمويل يعتمد على معاملات الدفع بالبطاقات الخاصة بعملك. عملية بسيطة وشفافة، مصممة خصيصًا للشركات التي تحقق مبيعات منتظمة عبر أجهزة نقاط البيع.",
      // Business Loans
      ...
      // Secured Loans
      securedLoansTitle: "التمويل التجاري",
      securedLoansHighlight: "المضمون بأصول",
      securedLoansDesc: "استثمر قيمة أصولك للحصول على شروط تمويلية تفضيلية وسقوف ائتمانية أعلى. حوّل عقاراتك أو معداتك أو مخزونك إلى سيولة فعّالة.",
      securedLoansFeaturesTitle: "مزايا التمويل المضمون بأصول",
      securedLoansFeaturesDesc: "احصل على أفضل الشروط والأسعار من خلال تقديم ضمانات عينية تعزز ملفك الائتماني.",
      lowerInterestRates: "هوامش ربح تنافسية",
      lowerInterestRatesDesc: "أسعار تفضيلية بفضل الضمانات العينية المقدمة، مما يخفّض التكلفة الإجمالية للتمويل",
      extendedTenure: "فترات سداد ممتدة",
      extendedTenureDesc: "آجال سداد مرنة تصل إلى 84 شهراً تتناسب مع حجم التمويل وطبيعة النشاط",
      higherLoanAmounts: "سقوف ائتمانية أعلى",
      higherLoanAmountsDesc: "تمويل يصل إلى 80% من القيمة السوقية للأصول المرهونة",
      ...
      // SME Loans
      smeLoansTitle: "حلول تمويل مرنة مصممة",
      smeLoansHighlight: "للمنشآت الصغيرة والمتوسطة",
      ...
      growthFocused: "تمويل موجّه للنمو",
      growthFocusedDesc: "حلول تمويلية مصممة لمساعدة المنشآت الصغيرة والمتوسطة على التوسع وتطوير عملياتها",
      fastProcessing: "إجراءات سريعة",
      fastProcessingDesc: "عملية توثيق مبسطة مع سرعة في الاستجابة والمعالجة",
      dedicatedSupport: "دعم متخصص",
      dedicatedSupportDesc: "مدير علاقات مخصص يتفهّم طبيعة تحديات المنشآت الصغيرة والمتوسطة",
      flexibleTerms: "شروط سداد مرنة",
      flexibleTermsDesc: "جداول سداد مخصصة تتوافق مع دورات التدفقات النقدية لأعمالك",
      smeLoansCtaTitle: "هل تتطلع إلى تنمية منشأتك؟",
      smeLoansCtaDesc: "احصل على تمويل مصمم خصيصاً لتطوير أعمالك. دعنا نناقش احتياجاتك.",
      // Corporate Loans
      corporateLoansTitle: "التمويل",
      ...
      premiumRatesDesc: "أسعار تنافسية للشركات المؤهلة تعكس قوة الملف الائتماني والعلاقة المصرفية",
      multiCurrencyOptions: "تمويل متعدد العملات",
      multiCurrencyOptionsDesc: "تسهيلات متاحة بالدرهم الإماراتي والدولار الأمريكي واليورو والعملات الرئيسية الأخرى",
      corporateLoansCtaTitle: "دعنا نناقش متطلبات شركتكم",
      corporateLoansCtaDesc: "فريقنا المتخصص في تمويل الشركات جاهز لهيكلة الحل الأمثل لاحتياجاتكم.",
      // Equipment Financing
      ...
      upTo80Financing: "تمويل يصل إلى 80% من قيمة المعدات",
      upTo80FinancingDesc: "تمويل يغطي حتى 80% من تكلفة شراء الآلات والمعدات",
      allAssetTypes: "تغطية شاملة لجميع أنواع الأصول",
      allAssetTypesDesc: "تمويل الآلات الصناعية والمركبات والتجهيزات التقنية والمعدات المتخصصة",
      maintenanceIncluded: "خيارات صيانة مدمجة",
      maintenanceIncludedDesc: "باقات اختيارية تشمل خدمات الصيانة الدورية والتغطية التأمينية",
      equipmentCtaTitle: "هل تبحث عن تمويل لشراء معداتك؟",
      equipmentCtaDesc: "سواء كانت معدات جديدة أو مستعملة، نوفر لك تمويلاً بشروط تنافسية مصممة لاحتياجاتك. تواصل معنا اليوم.",
      equipment: {
        termsApply: "تُطبَّق الشروط والأحكام",
        eligibility: {
          approvedManufacturers: "معدات من مصنّعين أو موزعين معتمدين",
          validLicense: "رخصة تجارية سارية المفعول تتوافق مع النشاط التجاري المعني",
          clearSpecs: "مواصفات فنية واضحة وعروض أسعار مفصّلة للمعدات",
          positiveCashFlow: "تدفقات نقدية تشغيلية إيجابية ومستقرة",
        },
        documents: {
          tradeLicense: "الرخصة التجارية وعقد إيجار المكتب (إيجاري) ومستندات تأسيس الشركة",
          quotation: "عرض سعر رسمي للمعدات صادر من موزع معتمد",
          specs: "المواصفات الفنية للمعدات والكتيبات التوضيحية",
        },
        advantage: {
          allIndustries: "تغطية جميع القطاعات",
          allIndustriesDesc: "قطاع التصنيع والبناء والخدمات اللوجستية والرعاية الصحية وغيرها",
          fleetFinancing: "تمويل الأساطيل",
          fleetFinancingDesc: "برامج مخصصة لتمويل المركبات التجارية وتوسيع أساطيل النقل",
          approvedDealers: "شبكة موزعين معتمدين",
          approvedDealersDesc: "شبكة واسعة من موردي ومصنّعي المعدات الموثوقين والمعتمدين",
          assetProtection: "حماية الأصول",
          assetProtectionDesc: "المعدات المموَّلة تُستخدم كضمان، مما يحافظ على أصولك الأخرى",
        },
      },
      // Trade Finance
      tradeFinanceTitle: "تمويل التجارة",
      tradeFinanceHighlight: "الدولية",
      tradeFinanceDesc: "يسّر عملياتك التجارية الدولية من خلال خطابات الاعتماد والضمانات المصرفية وحلول تمويل الاستيراد والتصدير. أمّن معاملاتك العابرة للحدود بأدوات مصرفية موثوقة.",
      tradeFinanceFeaturesTitle: "حلول شاملة لتمويل التجارة",
      tradeFinanceFeaturesDesc: "أدوات ومنتجات متكاملة لإدارة عملياتك التجارية الدولية بكفاءة واحترافية.",
      lettersOfCredit: "خطابات الاعتماد المستندية",
      lettersOfCreditDesc: "خطابات اعتماد مصرفية (مرئية وآجلة) لتأمين التزامات الدفع في المعاملات التجارية الدولية",
      importExportFinance: "تمويل الاستيراد والتصدير",
      importExportFinanceDesc: "تسهيلات تمويلية لمرحلتَي ما قبل الشحن وما بعده لضمان انسيابية سلسلة الإمداد",
      bankGuarantees: "الضمانات المصرفية",
      bankGuaranteesDesc: "ضمانات حسن الأداء، وخطابات ضمان الدفعات المقدمة، وضمانات العطاءات والمناقصات",
      tradeFinanceCtaTitle: "وسّع نطاق تجارتك العالمية",
      tradeFinanceCtaDesc: "أمّن معاملاتك التجارية الدولية مع حلول تمويل التجارة المتكاملة. دعنا نناقش احتياجاتك.",
      trade: {
        fundingOptions: "خيارات التمويل المتاحة",
        eligibility: {
          established: "شركة استيراد وتصدير مسجّلة ومرخّصة في دولة الإمارات",
          minYears: "خبرة لا تقل عن سنتين في العمليات التجارية",
          annualVolume: "حجم تجارة سنوي لا يقل عن 5 ملايين درهم إماراتي",
          validCodes: "رخص استيراد وتصدير سارية المفعول مع أكواد جمركية صالحة",
          relationships: "علاقات تجارية موثّقة مع الموردين أو المشترين",
          cleanRecord: "سجل نظيف لدى السلطات الجمركية والتنظيمية",
        },
        documents: {
          importExportCode: "شهادة تسجيل كود الاستيراد والتصدير",
          contracts: "عقود الموردين أو المشترين ووثائق التأمين ذات الصلة",
        },
        funding: {
          lc: "خطابات الاعتماد المستندية (LC)",
          lcDesc: "خطابات اعتماد مرئية وآجلة لتأمين التزامات الدفع في التجارة الدولية.",
          importExport: "تمويل الاستيراد والتصدير",
          importExportDesc: "تسهيلات تمويلية شاملة لمراحل ما قبل الشحن وما بعده لضمان استمرارية سلسلة الإمداد.",
          guarantees: "الضمانات المصرفية",
          guaranteesDesc: "ضمانات حسن الأداء، وخطابات ضمان الدفعات المقدمة، وضمانات العطاءات.",
          documentary: "الدفع مقابل المستندات (D/P)",
          documentaryDesc: "تحصيل مستندي آمن للمدفوعات عبر القنوات المصرفية المعتمدة.",
          insurance: "تأمين الائتمان التجاري",
          insuranceDesc: "تغطية تأمينية شاملة ضد مخاطر تعثّر المشتري والمخاطر السياسية والتجارية.",
          supplyChain: "تمويل سلسلة التوريد",
          supplyChainDesc: "تحسين كفاءة رأس المال العامل عبر مراحل سلسلة التوريد كاملةً.",
        },
        advantage: {
          globalNetwork: "شبكة مصرفية عالمية",
          globalNetworkDesc: "شراكات مصرفية استراتيجية تغطي أبرز الممرات التجارية حول العالم",
          endToEnd: "دعم شامل من البداية إلى النهاية",
          endToEndDesc: "من إصدار خطاب الاعتماد إلى متابعة الشحن وتحرير المدفوعات",
          portExpertise: "خبرة متعمّقة في عمليات الموانئ",
          portExpertiseDesc: "معرفة دقيقة بإجراءات وعمليات الموانئ الرئيسية في دولة الإمارات",
          riskMitigation: "إدارة المخاطر وتخفيفها",
          riskMitigationDesc: "تأمين معاملاتك التجارية بأدوات مصرفية موثوقة ومعتمدة دولياً",
        },
      },
      // Syndicated Loans
      ...
      // SME Loans eligibility
      validTradeLicenseEjari: "رخصة تجارية سارية المفعول وعقد إيجار (إيجاري)",
      noTurnoverDrop: "عدم تراجع في رقم الأعمال على أساس سنوي مقارَن",
      auditedOrManagement: "توفّر قوائم مالية مدققة أو حسابات إدارية",
      noMajorDefaults: "خلو السجل من التعثرات الجوهرية أو القضايا القانونية",
      // Corporate Loans eligibility
      strongCreditRating: "تصنيف ائتماني متين وسجل أداء مالي مثبت",
      clearCorporateGovernance: "هيكل حوكمة مؤسسية واضح ومتوافق مع المعايير",
      profitableOperations: "عمليات تشغيلية مربحة مع أرباح قبل الفوائد والضرائب والاستهلاك (EBITDA) إيجابية",
      // Secured Loans eligibility
      clearTitleCollateral: "سند ملكية صريح وخالٍ من الموانع للأصول المقدمة كضمان",
      propertyValuation: "تقرير تقييم عقاري صادر عن جهة تقييم معتمدة",
      noExistingLiens: "خلو الأصول المقترحة كضمان من أي رهونات أو حجوزات قائمة",
      positiveNetWorth: "صافي حقوق ملكية إيجابي مع عمليات تشغيلية مربحة",
      // Common documents
      ...
      // SME documents
      businessPlanStartups: "خطة عمل تفصيلية (للشركات الناشئة)",
      financialStatements1to2: "قوائم مالية (لآخر سنة إلى سنتين)",
      // Corporate documents
      certificateIncorporation: "شهادة التأسيس (Certificate of Incorporation) وإيجاري المكتب وعقد التأسيس / النظام الأساسي",
      auditedFinancials3YearsDoc: "قوائم مالية مدققة (لآخر ثلاث سنوات)",
      boardResolution: "قرار مجلس الإدارة بالموافقة على طلب التمويل",
      existingFacilityLetters: "خطابات التسهيلات القائمة وجدول الالتزامات المالية",
      // Secured documents
      auditedFinancials2to3Years: "قوائم مالية مدققة (لآخر سنتين إلى ثلاث سنوات)",
      propertyTitleDeed: "سند ملكية العقار (Title Deed) وتقرير التقييم المعتمد",
      // Advantages
    ...
    businessLoansPage: {
      ...
      eiborBaseRate: "سعر إيبور الأساسي",
      ...
      whyChooseTaamul: "لماذا تختار تعامل؟",
      fastTransparent: "تمويل أعمال سريع وشفاف",
      fastTransparentDesc: "بسّطنا عملية تمويل الأعمال حتى تتمكن من التركيز على الأهم – تنمية أعمالك.",
      benefit1: "تجنّب تأخيرات التوثيق غير المكتمل",
      benefit2: "الوصول إلى أكثر من ١٥ بنكًا رائدًا في الإمارات",
      benefit3: "أسعار فائدة تنافسية تبدأ من ٧٪ سنويًا",
      benefit4: "مدة سداد مرنة تصل إلى ٤٨ شهرًا",
