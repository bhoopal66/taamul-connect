...
const translations = {
  ...
  ar: {
    ...
    loanPages: {
      ...
      tradeFinanceDesc: "يسّر عملياتك التجارية الدولية من خلال خطابات الاعتماد والضمانات المصرفية وحلول تمويل الاستيراد والتصدير. احمِ معاملاتك العابرة للحدود بأدوات مصرفية موثوقة.",
      tradeFinanceFeaturesTitle: "حلول متكاملة لتمويل التجارة",
      tradeFinanceFeaturesDesc: "كل ما تحتاجه لإدارة عملياتك التجارية الدولية بكفاءة وثقة.",
      lettersOfCredit: "خطابات الاعتماد",
      lettersOfCreditDesc: "تأمين معاملاتك التجارية الدولية من خلال خطابات اعتماد مصرفية معتمدة",
      importExportFinance: "تمويل الاستيراد والتصدير",
      importExportFinanceDesc: "حلول تمويلية لمرحلتَي ما قبل الشحن وما بعده لضمان سلاسة العمليات التجارية",
      bankGuarantees: "الضمانات المصرفية",
      bankGuaranteesDesc: "ضمانات حسن الأداء والدفعات المقدمة وضمانات المناقصات والعطاءات",
      tradeFinanceCtaTitle: "وسّع نطاق تجارتك الدولية",
      tradeFinanceCtaDesc: "احمِ معاملاتك التجارية الدولية واستفد من حلول تمويل التجارة المتكاملة لدينا.",
      trade: {
        ...
        funding: {
          ...
          lcDesc: "خطابات اعتماد مصرفية معتمدة لتأمين المعاملات التجارية الدولية.",
          importExport: "تمويل الاستيراد والتصدير",
          importExportDesc: "تمويل شامل لمراحل ما قبل الشحن وما بعده لضمان استمرارية العمليات.",
          guarantees: "الضمانات المصرفية",
          guaranteesDesc: "ضمانات حسن الأداء والدفعات المقدمة وضمانات المناقصات.",
          documentary: "الدفع مقابل المستندات",
          documentaryDesc: "معالجة آمنة للمدفوعات عبر القنوات المصرفية المعتمدة.",
          insurance: "تأمين الائتمان التجاري",
          insuranceDesc: "حماية شاملة من مخاطر تعثّر المشتري والمخاطر السياسية.",
          supplyChain: "تمويل سلسلة التوريد",
          supplyChainDesc: "تحسين إدارة رأس المال العامل عبر سلسلة التوريد بالكامل.",
        },
        advantage: {
