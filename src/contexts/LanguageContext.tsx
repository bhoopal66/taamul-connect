...
const translations = {
  en: {
    ...
    loanPages: {
      ...
      workingCapitalFeaturesTitle: "Why Choose Our Expertise for Your Working Capital Needs?",
  ...
  ar: {
    ...
    loanPages: {
      ...
      workingCapitalFeaturesTitle: "لماذا تختار خبرتنا لاحتياجات رأس المال العامل؟",
