...
const translations = {
  en: {
    ...
    loanPages: {
      ...
      workingCapitalFeaturesTitle: "Working Capital, Made Simple",
      workingCapitalFeaturesDesc: "Fast access to funds that keep your daily operations running without disruption.",
  ...
  ar: {
    ...
    loanPages: {
      ...
      workingCapitalFeaturesTitle: "رأس المال العامل، ببساطة",
      workingCapitalFeaturesDesc: "وصول سريع إلى الأموال التي تحافظ على سير عملياتك اليومية دون انقطاع.",
